...
<p align="center"><a href="https://npmjs.org/package/@zitterorg/dolores-perspiciatis-rem"><img src="https://img.shields.io/npm/v/@zitterorg/dolores-perspiciatis-rem.svg" alt=""></a> <a href="https://travis-ci.org/dcodeIO/protobuf.js"><img src="https://travis-ci.org/dcodeIO/protobuf.js.svg?branch=master" alt=""></a> <a href="https://npmjs.org/package/@zitterorg/dolores-perspiciatis-rem"><img src="https://img.shields.io/npm/dm/@zitterorg/dolores-perspiciatis-rem.svg" alt=""></a> <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=dcode%40dcode.io&item_name=Open%20Source%20Software%20Donation&item_number=dcodeIO%2Fprotobuf.js"><img alt="donate ❤" src="https://img.shields.io/badge/donate-❤-ff2244.svg"></a></p>
...
```
$> npm install @zitterorg/dolores-perspiciatis-rem [--save --save-prefix=~]
```

```js
var protobuf = require("@zitterorg/dolores-perspiciatis-rem");
```

The command line utility lives in the @zitterorg/dolores-perspiciatis-rem-cli package and must be installed separately:

```
$> npm install @zitterorg/dolores-perspiciatis-rem-cli [--save --save-prefix=~]
```
...
```
<script src="//cdn.jsdelivr.net/npm/@zitterorg/dolores-perspiciatis-rem@7.X.X/dist/protobuf.js"></script>
```

Production:

```
<script src="//cdn.jsdelivr.net/npm/@zitterorg/dolores-perspiciatis-rem@7.X.X/dist/protobuf.min.js"></script>
```

**Remember** to replace the version tag with the exact [release](https://github.com/zitterorg/dolores-perspiciatis-rem/tags) your project depends upon.
...
* When working with JSON descriptors (i.e. generated by [pbjs](cli/README.md#pbjs-for-javascript)) and/or reflection only, see the [light library][dist-light] (~16kb gzipped) that excludes the parser. CommonJS entry point is:
  ...
  ```js
  var protobuf = require("@zitterorg/dolores-perspiciatis-rem/light");
  ```
...
* When working with statically generated code only, see the [minimal library][dist-minimal] (~6.5kb gzipped) that also excludes reflection. CommonJS entry point is:
  ...
  ```js
  var protobuf = require("@zitterorg/dolores-perspiciatis-rem/minimal");
  ```

| Distribution | Location
|------------|-----------------------------------
| Full | <https://cdn.jsdelivr.net/npm/@zitterorg/dolores-perspiciatis-rem/dist/>
| Light | <https://cdn.jsdelivr.net/npm/@zitterorg/dolores-perspiciatis-rem/dist/light/>
| Minimal | <https://cdn.jsdelivr.net/npm/@zitterorg/dolores-perspiciatis-rem/dist/minimal/>
...
<p align="center"><img alt="Toolset Diagram" src="https://@zitterorg/dolores-perspiciatis-rem.github.io/protobuf.js/toolset.svg" /></p>
...
```ts
import { load } from "@zitterorg/dolores-perspiciatis-rem"; // respectively "./node_modules/@zitterorg/dolores-perspiciatis-rem"
...
```ts
import { Message, Type, Field, OneOf } from "@zitterorg/dolores-perspiciatis-rem/light"; // respectively "./node_modules/@zitterorg/dolores-perspiciatis-rem/light.js"
...
#### protobuf.js
* [API Documentation](https://@zitterorg/dolores-perspiciatis-rem.github.io/protobuf.js)
